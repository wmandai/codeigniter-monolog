...
/* GENERAL OPTIONS */
$config['handlers'] = array('file', 'slack', 'hipchat'); // valid handlers are file | new_relic | hipchat | sentry | slack
...
/* SLACK OPTIONS*/
$config['slack_webhook'] = '{SLACK_WEBHOOK_URL}'; // Your slack webhook URL
$config['slack_channel'] = '#{SLACK_CHANNEL}'; // Slack channel to send alerts
$config['slack_username'] = '{SLACK_USERNAME}'; // Your slack username

/* SENTRY OPTIONS */
$config['raven_client'] = '{SENTRY_DSN_KEY}'; // Get it by logging in to your sentry account
$config['raven_level'] = Logger::WARNING;
