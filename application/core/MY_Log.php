        ...
        foreach ($this->config['handlers'] as $value) {
            switch ($value) {
                ...
                case 'new_relic':
                    ...
                    break;
                case 'slack':
                    $handler = new SlackWebhookHandler($this->config['slack_webhook'], $this->config['slack_channel'], $this->config['slack_username']);
                    break;
                case 'sentry':
                    $handler = new RavenHandler(new Raven_Client($this->config['raven_client']), $this->config['raven_level']);
                    break;
                case 'hipchat':
